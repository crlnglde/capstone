       ...
       const closeModal = () => {
        ...
        useEffect(() => {
            const fetchResidents = async (barangay) => {
                ...
                try {
                    const response = await axios.get(`http://192.168.1.24:3003/get-brgyresidents?barangay=${barangay}`);
        ...
        useEffect(() => {
            const fetchAffectedFamilies = async () => {
                ...
                try {
                    const response = await axios.get(`http://192.168.1.24:3003/get-disaster/${disCode}`);
